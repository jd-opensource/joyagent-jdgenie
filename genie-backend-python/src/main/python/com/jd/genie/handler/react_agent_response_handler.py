"""
React agent response handler implementation.
"""
...
class ReactAgentResponseHandler(BaseAgentResponseHandler, AgentResponseHandler):
    """Handler for React agent responses."""
    ...
    async def handle(
        ...
        """
        Handle React agent response processing.
        ...
        try:
            ...
            logger.error(f"{request.request_id} ReactAgentResponseHandler handle error", exc_info=e)
            return None